...
namespace Forge3D
{
	...
	public class F3DCameraToolEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.BeginVertical("Box");
			camTool.PrimaryCamera = (Transform)EditorGUILayout.ObjectField("Primary camera:", camTool.PrimaryCamera, typeof(Transform), true);
			...
			if (camTool.PrimaryCamera)
			{
				...
				{
					camTool.PrimaryCameraOriginPos = camTool.PrimaryCamera.position;
					camTool.PrimaryCameraOriginRot = camTool.PrimaryCamera.rotation;
				}
				...
				if (GUILayout.Button("Align to origin"))
				{
					...
					camTool.PrimaryCamera.position = camTool.PrimaryCameraOriginPos;
					camTool.PrimaryCamera.rotation = camTool.PrimaryCameraOriginRot;
				}
			...
			EditorGUILayout.BeginVertical("Box");
			EditorGUILayout.BeginVertical("Box");
			camTool.SecondaryCamera = (Transform)EditorGUILayout.ObjectField("Secondary camera:", camTool.SecondaryCamera, typeof(Transform), true);
			EditorGUILayout.EndVertical();
